...
namespace Porumb_Denisa_Lab2.Controllers
{
    public class BooksController : Controller
    {
        private readonly Porumb_Denisa_Lab2Context _context;

        public BooksController(Porumb_Denisa_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var porumb_Denisa_Lab2Context = _context.Book.Include(b => b.Genre)
                                                         .Include(b => b.Author);
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.AuthorID = new SelectList(_context.Set<Author>(), "ID", "FullName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,AuthorID,Price,GenreID")] Book book)
        {
            ...
            ViewBag.AuthorID = new SelectList(_context.Set<Author>(), "ID", "FullName", book.AuthorID);
            return View(book);
        }
